"""
    ...
    Language: Italian (strict) - terminology aligned with the official Daikin
    RoCon HP operation/installation manuals (manuals/it/).

    Differences vs. the classic "it" translation (kept for backward
    compatibility) are limited to the entries documented below.
"""

translations_it_strict = {
    "heating": "Riscaldare",                          # manual operating-state label (was "Riscaldamento")
    "cooling": "Raffrescamento",                       # Daikin term for space cooling (was "Raffreddamento")
    "standby": "Standby",
    "hot_water_production": "Approntamento Acqua Calda",  # manual state (was "Produzione di Acqua Calda")
    ...
    "lowering": "Ridurre",                             # manual operating-state label (was "Abbassamento")
    "summer": "Estate",
    "automatic_1": "Automatico 1",
    "automatic_2": "Automatico 2",
    "weather_dependent": "Dipendente dal Clima",       # was "Dipendente dal Tempo" (Tempo = time, not weather)
    ...
    "err_E9026": "E9026 Sensore Tubo di Aspirazione",  # manual: "Suction pipe sensor" R3T (was "Sensore di Pressione")
    ...
    "err_E88": "E88 Errore di Comunicazione RoCon BM1",
    "err_E91": "E91 ID Bus Modulo CAN Duplicato",
    ...
    "missing_flow": "Assenza di circolazione",
    "low": "Basso",
    "normal": "Normale",
    "good": "Buono",
    "very_good": "Ottimo"
